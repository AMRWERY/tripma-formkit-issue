      ...
      <div class="bg-[#e7f4fa]">
        <div class="w-full p-4 space-y-12 lg:grid lg:grid-cols-2 lg:gap-x-6 lg:space-y-0">
          ...
          <div class="grid grid-cols-2 my-4">
            ...
            <div class="w-48 mt-3">
              <img src="https://ar.trivago.com/_static/images/2023hai/app_install_qr_code.png">
            </div>
          </div>

          <div>
            <img src="https://themehut.co/html/geair/assets/img/slider/slider_bg01.jpg"
              class="h-auto border border-[#1391d2] rounded-full w-[500px] ms-auto border-b-4 border-r-4 border-l-4">
          </div>
        </div>
      </div>
    </section>
