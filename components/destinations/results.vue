<template>
  <div>
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div
        class="grid items-center max-w-2xl grid-cols-2 mx-auto gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
        ...
        <p class="ms-auto">{{ $t('destinations.results') }}: <span class="text-blue-600 underline">{{
          store.filteredPlacesArray.length }}</span>
        </p>
      </div>
    </div>
  </div>
