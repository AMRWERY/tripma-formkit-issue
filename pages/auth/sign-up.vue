      ...
      <div class="absolute inset-0 flex flex-col items-center justify-center">
        <div class="w-full max-w-md py-2 mx-auto bg-white rounded-2xl">
          <div class="mx-auto max-w-screen-2xl">
            <h2 class="mb-4 text-2xl font-bold text-center text-gray-800 md:mb-4 lg:text-3xl">Sign up</h2>
            ...
            <FormKit type="form" id="register-form" v-model="data" :actions="false" :incomplete-message="false"
              ...
              <div class="flex flex-col gap-4 p-4">
                <div>
                  <FormKitSchema :schema="registrationSchema" />
                </div>
                ...
                <div class="relative flex items-center justify-center">
                  ...
                  <span class="relative px-4 text-sm text-gray-400 bg-white">Sign up with social</span>
                </div>
